...
public class Customer extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            {
                Class.forName("java.sql.DriverManager");
                Connection fon = (Connection) DriverManager.getConnection(DBConfig.getDbUrl(), DBConfig.getDbUser(), DBConfig.getDbPassword());
            ...
            {
                Class.forName("java.sql.DriverManager");
                Connection gon = (Connection) DriverManager.getConnection(DBConfig.getDbUrl(), DBConfig.getDbUser(), DBConfig.getDbPassword());
            ...
            {
                Class.forName("java.sql.DriverManager");
                Connection hon = (Connection) DriverManager.getConnection(DBConfig.getDbUrl(), DBConfig.getDbUser(), DBConfig.getDbPassword());
